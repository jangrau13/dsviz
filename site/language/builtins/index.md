...
Deliberately general: `split` and `lower` are string operations and `sum` is arithmetic. Nothing here solves part of a task, because anything problem-shaped is a function you write.
